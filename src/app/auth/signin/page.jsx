  ...
  return (
    ...
    <>
      ...
      <div className="flex justify-center h-[1000px] items-center bg-black-2">
        <div className="rounded-xl flex justify-center w-4/5 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="px-26 py-17.5 text-center">
                <Link className="mb-5.5 inline-block" href="/">
                ...
                <form>
                  ...
                  <div className="mb-5">
                    <button
                      type="submit"
                      onClick={submit}
                      className="w-full cursor-pointer btn btn-info rounded-lg border border-yellow-400 bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] p-4 text-gray-500 transition hover:bg-opacity-90"
                    >
                      Login
                    </button>
                  </div>
                  ...
                  <div className="mt-6 text-center flex justify-between text-[#AEB7C0]">
                    <p>
                      Don’t have any account?{" "}
