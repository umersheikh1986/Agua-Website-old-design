...
// <div className="flex justify-center h-[1000px] items-center bg-black-2">
...
//           <span className="mb-1.5 block font-medium text-[#AEB7C0]">
//             Start for free
//           </span>
...
//                   className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-yellow-400 focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-black"
//                 />
...
//                   className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-yellow-400 focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
//                 />
...
//                   className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-yellow-400 focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
//                 />
//                 <span className="absolute right-4 top-4 h-">
//                   <IoWalletOutline className="text-2xl text-gray-500 " />
//                 </span>
//               </div>
//             </div>
...
//                 onClick={submit}
//                 type="submit"
//                 className="w-full cursor-pointer rounded-lg border border-yellow-400 bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] p-4 text-gray-500 transition hover:bg-opacity-90"
//               >
//                 Create Account
//               </button>
//             </div>
...
//                 <Link href="/auth/signin" className="text-yellow-500">
//                   Sign in
//                 </Link>
//               </p>
//             </div>
...
const SignUp = () => {
  ...
  return (
    <div className="flex justify-center h-[1250px] items-center bg-black-2">
      <div className="rounded-xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <form onsubmit={submitHandler}>
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border py-4 px-6 text-black"
                  />
                </div>
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] py-4 text-gray-500 transition hover:bg-opacity-90"
                  >
                    Create Account
                  </button>
                </div>
